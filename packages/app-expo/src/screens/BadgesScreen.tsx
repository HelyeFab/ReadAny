  ...
  return (
    <Modal visible={open} transparent animationType="fade" onRequestClose={onClose}>
      ...
      >
        ...
        >
          <Text
            style={{ fontSize: ui(18), fontWeight: "700", color: "#fff8ed", textAlign: "center" }}
          >
            {title}
          </Text>
          <Text
          ...
          >
            ...
            >
              <Text style={{ fontSize: ui(14), fontWeight: "800", color: BADGE_SHARE_BUTTON_TEXT }}>
                {saveLabel}
              </Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={{ fontSize: ui(14), fontWeight: "800", color: "#fff8ed" }}>
                {shareLabel}
              </Text>
            </TouchableOpacity>
          </View>
