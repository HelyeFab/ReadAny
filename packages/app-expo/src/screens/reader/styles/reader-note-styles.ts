...
export const noteTooltipMdStyles = {
  body: { color: TOOLTIP_FG, fontSize: ui(13), lineHeight: ui(19) },
  textgroup: { color: TOOLTIP_FG, fontSize: ui(13), lineHeight: ui(19) },
  text: { color: TOOLTIP_FG, fontSize: ui(13), lineHeight: ui(19) },
  paragraph: {
    color: TOOLTIP_FG,
    fontSize: ui(13),
    lineHeight: ui(19),
