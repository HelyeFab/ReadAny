...
export const makeSheetStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    ...
    highlightText: { fontSize: fontSize.sm, color: colors.foreground, lineHeight: ui(18) },
    ...
    bookmarkLabel: { fontSize: fontSize.sm, fontWeight: fontWeight.medium, lineHeight: ui(20) },
    bookmarkSnippet: { fontSize: fontSize.xs, lineHeight: ui(16), marginTop: 2, opacity: 0.7 },
