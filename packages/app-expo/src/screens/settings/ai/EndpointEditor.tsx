    ...
    <View style={{ gap: 6 }}>
      {activeModel && models.includes(activeModel) && (
        <View style={{ flexDirection: "row", alignItems: "center", gap: 6, paddingVertical: 2 }}>
          <Text style={{ fontSize: ui(11), color: colors.mutedForeground }}>
            {t("settings.ai_activeModel", "当前模型")}:
          </Text>
          <Text style={{ fontSize: ui(12), color: colors.primary, fontWeight: "600" }}>
            {activeModel}
          </Text>
        </View>
      )}
      ...
      <Text style={{ fontSize: ui(10), color: colors.mutedForeground }}>
      ...
      <View style={styles.fieldGroup}>
        ...
        <View style={styles.previewCard}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
            ...
            {testModel !== "__auto__" && (
              <Text style={{ fontSize: ui(12), color: colors.primary, fontWeight: "500" }}>
                {testModel}
              </Text>
            )}
          </View>
